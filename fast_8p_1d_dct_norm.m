...
% multiply by (1/2) G1
y(1) = (1/2)*cos(pi/4)*x(1,3);
y(5) = (1/2)*cos(pi/4)*x(2,3);
% multiply by (1/2) G2
tmp0= cos(pi/4)*(-x(3,3)+x(4,3));
y(3) = (1/4)*(1/cos(3*pi/8))*(x(3,3) + tmp0);
y(7) = (1/4)*(1/cos(pi/8))*(-x(3,3) + tmp0);
...
y(2) = -(1/4)*(1/cos(5*pi/16))*(tmp1(4,1)+tmp1(5,1)-tmp1(6,1));
y(4) = -(1/4)*(1/cos(pi/16))*(-tmp1(4,1)+tmp1(5,1)+tmp1(7,1));
y(8) = (1/4)*(1/cos(3*pi/16))*(-tmp1(4,1)-tmp1(5,1)-tmp1(6,1));
y(6) = -(1/4)*(1/cos(7*pi/16))*(tmp1(4,1)-tmp1(5,1)+tmp1(7,1));